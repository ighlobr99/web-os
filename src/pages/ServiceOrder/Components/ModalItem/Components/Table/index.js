...
const Table = ({ data, handleGetItem }) => {
  ...
  const columns = [
    ...
    {
      field: 'status_question',
      title: language ? 'Status questions' : 'Status do questionário',
      filtering: false,
      sort: true,
      cellStyle: {
        width: '30%',
      ...
      render: rowData =>
        rowData.status_question === 'open'
          ? `${language ? 'Opened' : 'Aberto'}`
          : `${language ? 'Answered' : 'Respondido'}`,
    },
    {
      field: 'sample_sent',
